...
<template>
  <v-container class="sm-max-w-[90vw]">
    ...
    <div
      class="flex flex-row min-h-[80vh] pt-4 border-b-[#E6AE4F] border-b-solid border-b-2px"
    >
      <v-navigation-drawer
        v-model="drawer"
      ...
      <v-tabs-window v-model="currentSection" class="mx-a sm-w-a w-[90vw]">
